...
This Program works for same and different arrival times
*/
#include<stdio.h>
#include <stdlib.h>
...
int main()
{
    ...
    //sort
    qsort((void *)ps,n, sizeof(struct process_struct),comparatorAT);  //https://www.educative.io/answers/what-is-the-qsort-function-in-c
